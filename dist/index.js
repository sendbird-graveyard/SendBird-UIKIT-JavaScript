...
var Img = function Img(_ref) {
  ...
  }, React__default.createElement(SvgNoImage, {
    alt: alt,
    height: height,
    width: width
  }));
...
function changeTypeToIconComponent(type) {
  switch (type) {
    ...
    case Type.NEW_MESSAGE:
      return React__default.createElement(SvgIconNewMessage, null);
    ...
    case Type.SHEVRON_RIGHT:
      return React__default.createElement(SvgIconShevronRight, null);
...
var InviteMembers = function InviteMembers(props) {
  ...
  return React__default.createElement(Modal, {
    ...
    return !filterUser(idsToFilter)(user.userId) && React__default.createElement("div", {
      ...
      color: LabelColors.ONBACKGROUND_1
    }, user.nickname || user.userId)), React__default.createElement("label", {
      htmlFor: user.userId,
