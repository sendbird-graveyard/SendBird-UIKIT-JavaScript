...
var withSendbirdContext = function withSendbirdContext(
  ...
  var ContextAwareComponent = function ContextAwareComponent(props) {
    return React.createElement(SendbirdSdkContext.Consumer, null, function(
      context
    ) {
...
function changeTypeToIconComponent(type) {
  switch (type) {
    case Type$1.ADD:
      return React.createElement(IconAdd, null);

    case Type$1.ARROW_LEFT:
      return React.createElement(IconArrowLeft, null);

    case Type$1.CAMERA:
      return React.createElement(IconCamera, null);

    case Type$1.ATTACH:
      return React.createElement(IconAttach, null);

    case Type$1.MORE:
      return React.createElement(IconMore, null);

    case Type$1.MUTE:
      return React.createElement(IconMute, null);

    case Type$1.CHECKBOX:
      return React.createElement(IconCheckbox, null);

    case Type$1.CHECKBOX_OFF:
      return React.createElement(IconCheckboxOff, null);

    case Type$1.CLOSE:
      return React.createElement(IconClose, null);

    case Type$1.COPY:
      return React.createElement(IconCopy, null);

    case Type$1.CHAT:
      return React.createElement(IconChat, null);

    case Type$1.CREATE:
      return React.createElement(IconCreate, null);

    case Type$1.DELETE:
      return React.createElement(IconDelete, null);

    case Type$1.DUMMY:
      return React.createElement(IconDummy, null);

    case Type$1.EDIT:
      return React.createElement(IconEdit, null);

    case Type$1.ERROR:
      return React.createElement(IconError, null);

    case Type$1.ERROR_FILLED:
      return React.createElement(IconErrorFilled, null);

    case Type$1.DELIVERED:
      return React.createElement(IconDelivered, null);

    case Type$1.DOCUMENT:
      return React.createElement(IconDocument, null);

    case Type$1.DOWNLOAD:
      return React.createElement(IconDownload, null);

    case Type$1.FILE_AUDIO:
      return React.createElement(IconFileAudio, null);

    case Type$1.FILE_DOCUMENT:
      return React.createElement(IconFileDocument, null);

    case Type$1.GIF:
      return React.createElement(IconGif, null);

    case Type$1.INFO:
      return React.createElement(IconInfo, null);

    case Type$1.LEAVE:
      return React.createElement(IconLeave, null);

    case Type$1.NEW_MESSAGE:
      return React.createElement(IconNewMessage, null);

    case Type$1.MEMBERS:
      return React.createElement(IconMembers, null);

    case Type$1.NOTIFICATIONS:
      return React.createElement(IconNotifications, null);

    case Type$1.PHOTO:
      return React.createElement(IconPhoto, null);

    case Type$1.PLAY:
      return React.createElement(IconPlay, null);

    case Type$1.PLUS:
      return React.createElement(IconPlus, null);

    case Type$1.READ:
      return React.createElement(IconRead, null);

    case Type$1.REFRESH:
      return React.createElement(IconRefresh, null);

    case Type$1.SEND:
      return React.createElement(IconSend, null);

    case Type$1.SENT:
      return React.createElement(IconSent, null);

    case Type$1.SHEVRON_RIGHT:
      return React.createElement(IconShevronRight, null);

    case Type$1.SPINNER:
      return React.createElement(IconSpinner, null);

    case Type$1.USER:
      return React.createElement(IconUser, null);
  ...
  return createPortal(
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(ModalHeader$1, {
          titleText: titleText
        }),
        React.createElement(ModalBody, null, children),
        !hideFooter &&
          React.createElement(ModalFooter$1, {
            onCancel: onCancel,
            onSubmit: onSubmit,
...
function ChannelPreviewAction(_ref) {
  ...
  return React.createElement(
    ...
    showModal &&
      React.createElement(LeaveChannel, {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      (!sdkIntialized || loading) &&
        React.createElement(ChannelsPlaceholder, {
          type: PlaceHolderTypes.LOADING
        }), //  placeholder
...
function Message(props) {
  ...
  return React.createElement(
    ...
    isByMe
      ? React.createElement(OutgoingUserMessage, {
          message: message,
          showEdit: showEdit,
...
var MessageSwitch = function MessageSwitch(_ref3) {
  ...
  return React.createElement(
    ...
    isByMe
      ? React.createElement(OutgoingFileMessage, {
          message: message,
          showRemove: showRemove,
          status: status
        })
...
function FileViewer(props) {
  ...
  return createPortal(
    React.createElement(FileViewerComponent, {
...
function MessageHoc(_ref) {
  ...
  return React.createElement(
    ...
    ((message.isFileMessage && message.isFileMessage()) ||
      ...
      React.createElement(
        ...
        isImage(message.type) || isVideo(message.type)
          ? React.createElement(ThumbnailMessage, {
              message: message,
              isByMe: isByMe,
    ...
    message.isAdminMessage &&
      message.isAdminMessage() &&
      React.createElement(AdminMessage, {
        message: message
      }),
    ...
    showRemove &&
      React.createElement(RemoveMessage, {
        onCloseModal: function onCloseModal() {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        subTitle ||
          React.createElement(AutoRefresh, {
...
var ChannelProfile = function ChannelProfile(props) {
  ...
  return React.createElement(
    ...
    showModal &&
      React.createElement(EditDetails, {
...
var MemebersAccordion = function MemebersAccordion(_ref) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      showAddUserModal &&
        React.createElement(InviteMembers, {
  ...
  return React.createElement(
    ...
    showSettings &&
      React.createElement(
        ...
        React.createElement(ChannelSetting, {
          channelUrl: currentChannelUrl,
          onCloseClick: function onCloseClick() {
    ...
    React.createElement(MenuRoot, null)
  );
}
App.propTypes = {
  appId: PropTypes.string.isRequired,
