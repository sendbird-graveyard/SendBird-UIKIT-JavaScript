...
var index = require('./index-c0f812fc.js');
...
function TextButton(_ref) {
  ...
  return React__default.createElement("div", {
    role: "button",
    tabIndex: 0,
    className: [].concat(LocalizationContext._toConsumableArray(injectingClassName), [changeColorToClassName(color), notUnderline ? 'sendbird-textbutton--not-underline' : 'sendbird-textbutton', disabled ? 'sendbird-textbutton--disabled' : '']).join(' '),
    onClick: onClick,
    onKeyPress: onClick
  }, children);
}
...
//# sourceMappingURL=index-ab7d3759.js.map
