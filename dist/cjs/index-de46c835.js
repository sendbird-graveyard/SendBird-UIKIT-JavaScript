...
function MessageSearchItem(_a) {
  ...
  }, nickname || stringSet.NO_NAME), React__default.createElement(index.Label, {
  ...
  }, messageText), React__default.createElement(index.Label, {
...
function getIconOfFileType(message) {
  ...
  if (/(jpg|jpeg|png)$/i.test(fileExtension)) {
    return index.IconTypes.PHOTO;
  } else if (/mp4$/i.test(fileExtension)) {
    return index.IconTypes.PLAY;
  } else if (/mp3/i.test(fileExtension)) {
    return index.IconTypes.FILE_AUDIO;
  } else if (/gif/i.test(fileExtension)) {
    return index.IconTypes.GIF;
  } else {
    return index.IconTypes.FILE_DOCUMENT;
  }
}
...
function MessageSearchFileItem(props) {
  ...
  return React__default.createElement("div", {
    ...
    type: index.LabelTypography.BODY_2,
    color: index.LabelColors.ONBACKGROUND_1
  }, truncate(name || fileMessageUrl, 28)))), React__default.createElement(index.Label, {
...
function MessageSearch(props) {
  ...
  if (loading && searchString) {
    return React__default.createElement("div", {
      ...
      type: index.PlaceHolderTypes$1.SEARCHING
    }));
  }
  ...
  if (!searchString) {
    return React__default.createElement("div", {
      ...
      type: index.PlaceHolderTypes$1.SEARCH_IN,
  ...
  return React__default.createElement("div", {
    ...
    type: index.PlaceHolderTypes$1.NO_RESULTS
  }));
}
...
function MessageSearchPannel(props) {
  ...
  return React__default.createElement("div", {
  ...
  }), inputString && loading && React__default.createElement(index.Loader, {
    ...
    width: "20px",
    height: "20px"
  })), !loading && inputString && React__default.createElement(index.Icon, {
  ...
  }, React__default.createElement(MessageSearch$1, {
    channelUrl: channelUrl,
    searchString: searchString,
    onResultClick: onResultClick,
...
//# sourceMappingURL=index-de46c835.js.map
