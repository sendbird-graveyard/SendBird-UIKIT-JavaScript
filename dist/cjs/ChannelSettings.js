...
var LeaveChannel = require('./LeaveChannel-98ec2568.js');
var index$2 = require('./index-3f565819.js');
var index$1 = require('./index-6f3ccdcb.js');
var index$3 = require('./index-5e5ae32b.js');
var utils = require('./utils-1590929e.js');
var index$4 = require('./index-f2a5172d.js');
require('react-dom');
    ...
    onScroll: function onScroll(e) {
      ...
      if (hasNext && fetchMore) {
        memberQuery.next(function (o, error) {
          ...
          setMembers(LocalizationContext.__spreadArray(LocalizationContext.__spreadArray([], members), o));
        });
      }
    }
...
var UserListItem = function UserListItem(_a) {
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ref: parentRef,
    className: LocalizationContext.__spreadArray([COMPONENT_NAME], injectingClassNames).join(' ')
    ...
    onScroll: function onScroll(e) {
      ...
      if (hasNext && fetchMore) {
        operatorQuery.next(function (o, error) {
          ...
          setOperators(LocalizationContext.__spreadArray(LocalizationContext.__spreadArray([], operators), o));
        });
      }
    }
