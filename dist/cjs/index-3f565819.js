...
function Avatar(_a, ref) {
  var _b = _a.className,
      ...
      customDefaultComponent = _a.customDefaultComponent;
  return /*#__PURE__*/React__default['default'].createElement("div", {
    className: LocalizationContext.__spreadArray(LocalizationContext.__spreadArray([], Array.isArray(className) ? className : [className]), ['sendbird-avatar']).join(' '),
    role: "button",
    ref: ref,
    style: {
      height: height,
...
//# sourceMappingURL=index-3f565819.js.map
