...
var index = require('./index-d9a48d62.js');
...
function Accordion(_a) {
  ...
  function (value) {
    ...
    return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement("div", {
      className: LocalizationContext.__spreadArray(LocalizationContext.__spreadArray([], Array.isArray(className) ? className : [className]), ['sendbird-accordion__panel-header']).join(' '),
      id: id,
      role: "switch",
      "aria-checked": false,
      onClick: handleClick,
      ...
      tabIndex: 0
    }, renderTitle(), /*#__PURE__*/React__default['default'].createElement(index.Icon, {
...
//# sourceMappingURL=index-599bdf5d.js.map
