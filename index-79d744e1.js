...
React.createElement("g", {
  ...
  fill: "#000",
  d: "M37.295 12.952c.464 0 .906.182 1.223.501l9.029 9.107c.291.293.453.68.453 1.083v22.785c0 2.53-2.073 4.62-4.685 4.62h-22.63c-2.612 0-4.685-2.09-4.685-4.62V17.572c0-2.53 2.073-4.62 4.685-4.62zm1.618 25.143H24.325l-.134.007c-.748.07-1.334.731-1.334 1.536 0 .852.657 1.543 1.468 1.543h14.588l.134-.006c.748-.071 1.334-.732 1.334-1.537 0-.852-.657-1.543-1.468-1.543zm0-6.095H24.325l-.134.006c-.748.071-1.334.732-1.334 1.537 0 .852.657 1.543 1.468 1.543h14.588l.134-.007c.748-.07 1.334-.731 1.334-1.536 0-.852-.657-1.543-1.468-1.543zm-7.672-6.095h-6.857l-.139.006a1.537 1.537 0 00-1.388 1.537c0 .852.684 1.542 1.527 1.542h6.857l.14-.006a1.536 1.536 0 001.387-1.536c0-.852-.684-1.543-1.527-1.543z"
}));
...
React.createElement("g", {
  ...
  fill: "#000",
  d: "M44.468 34.271c1.154-.72 1.151-1.902.008-2.633l-19.76-12.635c-1.149-.735-2.067-.228-2.05 1.148l.318 25.018c.017 1.37.968 1.894 2.12 1.176l19.364-12.074z"
}));
...
function PlaceHolder(_ref) {
  ...
  return React.createElement("div", {
    ...
    type: LabelTypography.BUTTON_2,
    color: LabelColors.PRIMARY
  }, "'".concat(searchInString, "'"))), type === PlaceHolderTypes$1.SEARCHING && React.createElement(Label, {
    type: LabelTypography.BODY_1,
    color: LabelColors.ONBACKGROUND_2
...
//# sourceMappingURL=index-79d744e1.js.map
